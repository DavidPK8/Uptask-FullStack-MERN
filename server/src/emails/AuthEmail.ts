...
export class AuthEmail {
              ...
              <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <div style="padding: 30px;">
                  ...
                  <p style="font-size: 16px; line-height: 1.5; color: #555;">
                    Has creado tu cuenta en <strong>UpTask</strong>, ¡ya casi está todo listo! Solo debes confirmar tu cuenta para poder comenzar a usarla.
                  </p>
                  ...
                  <div style="text-align: center; margin: 20px 0;">
                    <a href="${confirmUrl}"
                      style="display: inline-block; padding: 10px 20px; background-color: #4f46e5; color: white; text-decoration: none; font-weight: bold; border-radius: 5px;">
                      Confirmar Cuenta
                    </a>
                  </div>

                  <p style="font-size: 16px; line-height: 1.5; color: #555;">
                    E ingresa el siguiente código manualmente:
                  </p>
                  ...
                  <p style="font-size: 16px; line-height: 1.5; color: #555;">
                    <strong>Nota:</strong> Este token expira en 5 minutos.
                  </p>
    ...
    static sendPasswordReset = async (user: IEmail) => {
        const confirmUrl = `${process.env.FRONTEND_URL}/auth/new-password`;

        await transporter.sendMail({
            from: `"Uptask" <${process.env.SMTP_USER}>`,
            to: user.email,
            subject: "Reestablece tu password en Uptask",
            html: `
            <div style="font-family: Arial, sans-serif; background-color: #f5f7fa; padding: 40px;">
              <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                <div style="background-color: #4f46e5; padding: 20px; text-align: center;">
                ...
                <div style="padding: 30px;">
                  <h2 style="color: #333;">¡Hola ${user.userName}!</h2>
                  <p style="font-size: 16px; line-height: 1.5; color: #555;">
                    Has solicitado reestablecer tu password en <strong>UpTask</strong>.
                  </p>
                  
                  <p style="font-size: 16px; line-height: 1.5; color: #555;">
                    Visita el siguiente enlace para seguir con el siguiente paso:
                  </p>
                  ...
                  <p style="text-align: center; color: #999; font-size: 14px; margin-top: 20px;">
                    Si no has solicitado reestablecer tu password, puedes ignorar este mensaje.
                  </p>
                </div>
              </div>
