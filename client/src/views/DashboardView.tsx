                ...
                {data.length ? (
                    <ul role="list" className="mt-10">
                        {data.map((project) => (
                            <li
                                key={project._id}
                                className="flex justify-between border-2 border-purple-400 gap-x-6 px-5 py-10 mt-5 bg-white rounded-lg shadow-lg shadow-purple-200"
                            >
                                        ...
                                        >
                                            <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                                <MenuItem>
                                                    <Link
                                                        to={`/projects/${project._id}`}
                                                        className="block px-3 py-1 text-sm leading-6 text-gray-900 hover:underline transition"
                                                    >
                                                        Ver Proyecto
                                                    </Link>
                                                </MenuItem>
